        ...
        >
          ...
          >
            <div className="px-6 py-7 space-y-5 text-sm">
              ...
              {/* Links */}
              <a href="#" onClick={() => setMobileMenuOpen(false)} className="block py-2 rounded hover:bg-[#37475a] px-2">
              ...
              <a href="/cart" onClick={() => setMobileMenuOpen(false)} className="flex items-center py-4 px-2 rounded hover:bg-[#37475a]">
                <div className="relative">
                  <span className="absolute -top-4 left-3 text-orange-400 font-bold text-lg">0</span>
                  <BiCart className="text-3xl text-white" />
                </div>
